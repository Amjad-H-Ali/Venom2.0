...
TEST(LexerNumberTest, NumbersAndOperators) { 
    ...
    ASSERT_EQ(17, end_of_tokens_list);
    ...
    test_tokens[W_TOKEN_INIT+1] = 
        // ++0-- == INC, NUM, DEC
        INC | (static_cast<uint64_t>(NUM) << 8) | (static_cast<uint64_t>(0x0) << 16);
    ...
    test_tokens[W_TOKEN_INIT+3] =
        // continued...
        INC |
        // 100+281474976710655==9. == NUM, PLUS, NUM, EQ, NUM
        (static_cast<uint64_t>(NUM) << 8) | (static_cast<uint64_t>(0x64) << 16);
    
    test_tokens[W_TOKEN_INIT+4] =
        // continued...
        PLUS | (static_cast<uint64_t>(NUM) << 8) | (static_cast<uint64_t>(0xFFFFFFFFFFFF) << 16);
    
    test_tokens[W_TOKEN_INIT+5] =
        // continued...
        EQ | (static_cast<uint64_t>(NUM) << 8) | (static_cast<uint64_t>(0x9) << 16);
    
    test_tokens[W_TOKEN_INIT+6] = 
        // 10*10*10 == NUM, MUL, NUM, MUL, NUM
        NUM | (static_cast<uint64_t>(0xA) << 8) | (static_cast<uint64_t>(MUL) << 56);
    ...
    test_tokens[W_TOKEN_INIT+8] = 
        // continued...
        NUM | (static_cast<uint64_t>(0xA) << 8) |
        // 10&20|30
        (static_cast<uint64_t>(NUM) << 56);
    
    test_tokens[W_TOKEN_INIT+9] =
        // continued...
        0xA | (static_cast<uint64_t>(BAND) << 48) | (static_cast<uint64_t>(NUM) << 56);
    
    test_tokens[W_TOKEN_INIT+10] =
        // continued...
        0x14 | (static_cast<uint64_t>(BOR) << 48) | (static_cast<uint64_t>(NUM) << 56);
    
    test_tokens[W_TOKEN_INIT+11] =
        // continued...
        0x1E |
        // 9/3 * 10
        (static_cast<uint64_t>(NUM) << 48) | (static_cast<uint64_t>(0x9) << 56);
    
    test_tokens[W_TOKEN_INIT+12] =
        // continued...
        (static_cast<uint64_t>(DIV) << 40) | (static_cast<uint64_t>(NUM) << 48) | (static_cast<uint64_t>(0x3) << 56);
    
    test_tokens[W_TOKEN_INIT+13] =
        // continued...
        (static_cast<uint64_t>(MUL) << 40) | (static_cast<uint64_t>(NUM) << 48) | (static_cast<uint64_t>(0xA) << 56);
